...
<div class="container">
	<form:form method="POST" modelAttribute="servicesDto"
		enctype="multipart/form-data" class="form-horizontal"
		action="${contextRoot}/admin/save/services">

		<div class="modal fade" id="addmodal" role="dialog">
			<div class="modal-dialog">
				<!--Modal will be prompt up when admin clicks on add services button   -->
				<!--data from this modal will be sent through modelattribute  -->
				<!-- Modal content-->
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<!--here to add services there is a script at adminAddProduct page when categoryid=0 it will get added  -->
						...
						<div class="form-group">
							...
							<form:input type="text" path="serviceQuantity"
								class="form-control" id="serviceQuantity" />
							<div class="has-error">
